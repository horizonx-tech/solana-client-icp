//e std::{collections::HashMap, sync::Arc};//
//e futures::lock::Mutex;
//e serde::de;
//e serde_json::{json, Value};
//e solana_extra_wasm::{transaction_status::UiTransactionEncoding, utils::sleep};
//e solana_sdk::{pubkey::Pubkey, signature::Signature};//
//e crate::{
...
//  }
//}//
//b type SubscriptionId = u64;//
//derive(Debug, Deserialize)]
//b struct SubscriptionNotification<T> {
//  jsonrpc: String,
//  method: String,
//  params: SubscriptionParams<T>,
//}//
//derive(Debug, Deserialize)]
//b struct SubscriptionParams<T> {
//  result: T,
...
//}//
//cfg(test)]
//sm_bindgen_test::wasm_bindgen_test_configure!(run_in_browser);//
//cfg(test)]
//b mod test {
